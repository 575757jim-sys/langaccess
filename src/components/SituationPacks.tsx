...
import { Volume2, Loader2, ChevronDown, ChevronUp, Users, BookOpen, Stethoscope, HardHat, CheckCircle, AlertTriangle } from 'lucide-react';
...
const SITUATION_PACKS: SituationPack[] = [
  ...
  {
    id: 'confirmation',
    title: 'Confirmation & Understanding Pack',
    description: 'Verify comprehension and confirm instructions.',
    icon: CheckCircle,
    iconBg: 'bg-sky-100',
    ...
    phrases: [
      ...
      {
        english: 'Please repeat what I said.',
        translations: {
          spanish: 'Por favor repita lo que dije.',
          mandarin: '请重复我说的话。',
          cantonese: '請重複我所說的。',
          vietnamese: 'Xin hãy lặp lại những gì tôi nói.',
          tagalog: 'Mangyaring ulitin ang sinabi ko.',
          hmong: 'Thov hais dua li kuv hais.',
          korean: '제가 한 말을 반복해 주세요.',
          arabic: 'من فضلك كرر ما قلته.',
        },
      },
      {
        english: 'Can you show me?',
        translations: {
          spanish: '¿Puede mostrarme?',
          mandarin: '你能告诉我吗？',
          cantonese: '你可以告訴我嗎？',
          vietnamese: 'Bạn có thể chỉ cho tôi không?',
          tagalog: 'Maaari mo bang ipakita sa akin?',
          hmong: 'Puas muaj peev xwm qhia kuv?',
          korean: '보여주실 수 있나요?',
          arabic: 'هل يمكنك أن تريني؟',
        },
      },
      {
        english: 'Please point to it.',
        translations: {
          spanish: 'Por favor señálelo.',
          mandarin: '请指给我看。',
          cantonese: '請指俾我睇。',
          vietnamese: 'Xin hãy chỉ vào đó.',
          tagalog: 'Mangyaring ituro ito.',
          hmong: 'Thov taw tes mus rau.',
          korean: '그것을 가리켜 주세요.',
          arabic: 'من فضلك أشر إليه.',
        },
      },
      {
        ...
        translations: {
          ...
          mandarin: '可以吗？',
          cantonese: '可以嗎？',
          vietnamese: 'Điều đó có được không?',
          tagalog: 'Ayos ba iyon?',
          hmong: 'Puas zoo li ntawd?',
          korean: '괜찮으신가요?',
          arabic: 'هل هذا بخير؟',
        },
      },
      {
        ...
        translations: {
          ...
          mandarin: '您需要帮助吗？',
          cantonese: '你需要幫助嗎？',
          vietnamese: 'Bạn có cần giúp đỡ không?',
          tagalog: 'Kailangan mo ba ng tulong?',
          hmong: 'Puas xav tau kev pab?',
          korean: '도움이 필요하신가요?',
          arabic: 'هل تحتاج إلى مساعدة؟',
        },
      },
      {
        english: 'Yes or no?',
      ...
      },
      {
        ...
        translations: {
          ...
          mandarin: '在这里等。',
          cantonese: '喺度等。',
          vietnamese: 'Chờ ở đây.',
          tagalog: 'Maghintay dito.',
          hmong: 'Tos ntawm no.',
          korean: '여기서 기다리세요.',
          arabic: 'انتظر هنا.',
        },
  ...
  {
    id: 'urgency',
    title: 'Urgency, Safety & Immediate Action Pack',
    description: 'Quick instructions during urgent or high-stress situations.',
    icon: AlertTriangle,
    iconBg: 'bg-red-100',
    ...
    phrases: [
      ...
      },
      {
        english: 'Stay here.',
        translations: {
          spanish: 'Quédese aquí.',
          mandarin: '留在这里。',
          cantonese: '留喺度。',
          vietnamese: 'Ở lại đây.',
          tagalog: 'Manatili dito.',
          hmong: 'Nyob ntawm no.',
          korean: '여기 있으세요.',
          arabic: 'ابق هنا.',
        },
      ...
      },
      {
        ...
        translations: {
          spanish: 'La ayuda está en camino.',
          mandarin: '救援正在赶来。',
          cantonese: '救援快嚟喇。',
          vietnamese: 'Đội cứu hộ đang đến.',
          tagalog: 'Paparating ang tulong.',
          hmong: 'Kev pab yuav tuaj.',
          korean: '도움이 오고 있습니다.',
          arabic: 'المساعدة في الطريق.',
        },
      },
      {
        english: 'Call 911.',
        translations: {
          spanish: 'Llame al 911.',
          mandarin: '拨打911。',
          cantonese: '致電911。',
          vietnamese: 'Gọi 911.',
          tagalog: 'Tumawag sa 911.',
          hmong: 'Hu 911.',
          korean: '911에 전화하세요.',
          arabic: 'اتصل بـ 911.',
        },
      ...
      {
        english: 'Are you in danger?',
        translations: {
          spanish: '¿Está en peligro?',
          mandarin: '您在危险中吗？',
          cantonese: '你係咪有危險？',
          vietnamese: 'Bạn có đang gặp nguy hiểm không?',
          tagalog: 'Nasa panganib ka ba?',
          hmong: 'Puas nyob hauv kev phom sij?',
          korean: '위험에 처해 계신가요?',
          arabic: 'هل أنت في خطر؟',
        },
      },
      {
        english: 'Move back.',
        translations: {
          spanish: 'Muévase hacia atrás.',
          mandarin: '后退。',
          cantonese: '後退。',
          vietnamese: 'Lùi lại.',
          tagalog: 'Lumayo.',
