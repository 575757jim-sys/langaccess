...
import { Languages, Heart, GraduationCap, HardHat, ArrowLeft, FileText, MessageSquarePlus, Compass, RefreshCw, Award, Users, ChevronRight, Handshake, Star, HandHeart, Bell, Barcode, Building2, Wheat, Volume2, Loader2, TrendingUp, ClipboardCheck, Route } from 'lucide-react';
...
export default function HomeScreen({
  ...
  return (
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      {/* Header */}
      <header className="bg-white border-b border-slate-200 sticky top-0 z-20" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
          ...
          <>
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xs font-semibold text-slate-400 uppercase tracking-widest whitespace-nowrap">Your Learning</span>
                <div className="flex-1 h-px bg-slate-200" />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <a
                  href="/learn/mastery"
                  className="group bg-white border border-slate-200 hover:border-blue-300 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.98] flex flex-col gap-2"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center flex-shrink-0">
                      <TrendingUp className="w-5 h-5 text-blue-600" />
                    </div>
                    <div className="font-bold text-slate-800 text-sm">Mastery Map</div>
                  </div>
                  <p className="text-xs text-slate-500 leading-snug">Track phrases you've seen, heard, and used.</p>
                </a>

                <a
                  href="/learn/assessment"
                  className="group bg-white border border-slate-200 hover:border-emerald-300 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.98] flex flex-col gap-2"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center flex-shrink-0">
                      <ClipboardCheck className="w-5 h-5 text-emerald-600" />
                    </div>
                    <div className="font-bold text-slate-800 text-sm">Self-Assessment</div>
                  </div>
                  <p className="text-xs text-slate-500 leading-snug">Rate your confidence before and after practice.</p>
                </a>

                <a
                  href="/learn/scenarios"
                  className="group bg-white border border-slate-200 hover:border-amber-300 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.98] flex flex-col gap-2"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-amber-50 rounded-lg flex items-center justify-center flex-shrink-0">
                      <Route className="w-5 h-5 text-amber-600" />
                    </div>
                    <div className="font-bold text-slate-800 text-sm">Scenario Chains</div>
                  </div>
                  <p className="text-xs text-slate-500 leading-snug">Practice real multi-step moments end to end.</p>
                </a>
              </div>
            </div>
